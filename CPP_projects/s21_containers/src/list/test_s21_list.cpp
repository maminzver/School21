...
TEST(list, insert_many_back_single_element_list) {
  s21::list<int> our;
  our.insert_many_back(1);
  std::list<int> stl;
  stl.push_back(1);
  EXPECT_EQ(stl.back(), our.back());
}
TEST(list, insert_many_back_multiple_elements_list) {
  s21::list<int> our;
  our.insert_many_back(1, 2, 3);
  std::list<int> stl;
  stl.push_back(1);
  stl.push_back(2);
  stl.push_back(3);
...
TEST(list, insert_many_back_empty_list) {
  s21::list<int> our;
  our.insert_many_back();
  std::list<int> stl;
  EXPECT_TRUE(our.empty());
}
TEST(list, insert_many_front_single_element_list) {
  s21::list<int> our;
  our.insert_many_front(1);
  std::list<int> stl;
  stl.push_front(1);
  EXPECT_EQ(stl.front(), our.front());
}
TEST(list, insert_many_front_multiple_elements_list) {
  s21::list<int> our;
...
TEST(list, insert_many_front_empty_list) {
  s21::list<int> our;
  our.insert_many_front();
  std::list<int> stl;
  EXPECT_TRUE(our.empty());
}
